  ...
  <div class="container">
    ...
    <div class="seeks">
      <div class="seeks-each">
        <p>角色名称：</p>
        <el-input v-model="seek.name" clearable></el-input>
      </div>

      <div class="seeks-each">
        <p>角色状态：</p>
        <el-input v-model="seek.status" clearable></el-input>
      </div>

      <!-- 查询和重置按钮 -->
      <div class="seek-btns">
        <el-button size="small" type="primary" icon="el-icon-search" @click="getRoleList(true)">查询</el-button>
...
import { getRoleList, addRole, updRole, delRole } from '@/api/user'
